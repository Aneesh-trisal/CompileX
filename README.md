...
- **Backend:** Node.js (for code execution)
- **AI Integration:** GPT-based models (Ollama / GPT4All)
...
```sh
git clone https://github.com/your-username/js-offline-compiler.git
cd js-offline-compiler
